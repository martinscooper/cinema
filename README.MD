...
- Runs a job that calls the `/api/index_movies` endpoint.
...
The auto-generated OpenAPI documentation can be founf at [http://localhost:8000/docs](http://localhost:8000/docs)
